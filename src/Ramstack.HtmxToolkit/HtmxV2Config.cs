...
public sealed class HtmxV2Config() : HtmxConfig(HtmxTargetVersion.V2)
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether a full page refresh should be issued on history misses rather than using an AJAX request.
    ...
    /// <summary>
    /// Gets or sets the WebSocket reconnect delay.
    /// Defaults to <c>full-jitter</c>.
    /// </summary>
    ...
    /// Defaults to <see cref="HtmxScrollBehavior.Instant"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether out-of-band swaps nested in the main response are processed.
    /// Defaults to <see langword="true"/>.
    /// </summary>
    public bool? AllowNestedOobSwaps { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether history restoration requests include HTMX request headers.
    /// Defaults to <see langword="true"/>.
    /// </summary>
    public bool? HistoryRestoreAsHxRequest { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether form validity is reported before a request is issued.
    /// Defaults to <see langword="false"/>.
    /// </summary>
